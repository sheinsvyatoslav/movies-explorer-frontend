...
export default function SearchForm(props) {
  ...
  function handleChangeName(e) {
    locationMovies ? props.setSearchInput(e.target.value) : setSearchInputSaved(e.target.value);
  }
    ...
    <section className="search">
      <div className="search__container">
        <form className="search__form" onSubmit={handleSubmit}>
          ...
          <input className="search__input" type="search" value={(locationMovies ? props.searchInput : searchInputSaved) || ''} onChange={handleChangeName} placeholder="Фильм" required id="movie-input" name="movie"></input>
        ...
        <div className="search__short">
          <button
            ...
            type="button"
            style={{
              backgroundImage: `url(${(locationMovies ? props.shortOn : props.shortOnSaved) ? shortActiveIcon : shortInactiveIcon})`
            }}>
          </button>
